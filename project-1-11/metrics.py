...
def getLicenseComp(owner, module):
    ...
    compatibleLicenses = ["bsd-2-clause", "bsd-3-clause", "lgpl-2.1", "mit", "unlicense"]
...
def getTotalScore(rsp_score, rmp_score, cor_score, bus_score, license_score):
    totalScore = ((2 * rsp_score + rmp_score + cor_score + 2 * bus_score) * license_score) / 6
    return totalScore