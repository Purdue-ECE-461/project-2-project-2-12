...
def test_get_package():
    response = requests.get(base_url + "package/underscore")
...
def test_post_package_create():
    ...
    response = requests.post(url, data=raw_data, auth=(user, token))
    assert response.status_code == 200
